const _ultimasComponent = {
    ...
    updated: function () {
        if (this.$ons.platform.isIOS() || this.$ons.platform.isIOS7above() || this.$ons.platform.isIOSSafari() || this.$ons.platform.isIPad() || this.$ons.platform.isIPhone() || this.$ons.platform.isIPhoneX() || this.$ons.platform.isIPod() || this.$ons.platform.isSafari()) {
            this.noticias.forEach(function (a) {
                a.render = true;
            });
        } else {
